...
check_balance() {
    ...
    local contract_id allocations amount wallet_id schema
    wallet_id=${WLT_ID_MAP[$wallet]}
    contract_id=${CONTRACT_ID_MAP[$contract_name]}
    schema=${CONTRACT_SCHEMA_MAP[$contract_name]}
...
issue_contract() {
    ...
    local contract_base contract_tmpl contract_yaml schema_id
    ...
    _trace "${RGB[@]}" -d "data${wallet_id}" state -w "$wallet" "$contract_id"
...
prepare_rgb_wallet() {
    ...
    _trace "${RGB[@]}" -d "data${wallet_id}" import -w "$wallet" \
        $SCHEMATA_DIR/NonInflatableAsset.rgb >$TRACE_OUT 2>&1
...
# install crates
install_rust_crate "bp-wallet" "$BP_WALLET_VER" "$BP_WALLET_FEATURES"
install_rust_crate "rgb-cmd" "$RGB_CMD_VER" "$RGB_CMD_FEATURES"
...
## single blinded xfer, broadcast+mine
scenario_100() {
    local method="opret1st"
    # wallets
    prepare_rgb_wallet wallet_0 $method
...
## single blinded xfer, no broadcast/mine
scenario_102() {
    local method="opret1st"
    # wallets
    prepare_rgb_wallet wallet_0 $method
...
## single blinded aborted+retried xfer, broadcast+mine
scenario_110() {
    local method="opret1st"
    # wallets
    prepare_rgb_wallet wallet_0 $method
    ...
    # transfers
    transfer_create wallet_0/wallet_1 2000/0     100 1900/100  0 0 usdt         # aborted
    transfer_assets wallet_0/wallet_1 2000/0     100 1900/100  0 1 usdt         # spend issuance
}

## single blinded aborted+retried xfer, no mine
scenario_111() {
    local method="opret1st"
    # wallets
    prepare_rgb_wallet wallet_0 $method
...
## single blinded aborted+retried xfer, no broadcast/mine
scenario_112() {
    local method="opret1st"
    # wallets
    prepare_rgb_wallet wallet_0 $method
...
## single witness xfer, broadcast+mine
scenario_200() {
    local method="opret1st"
    # wallets
    prepare_rgb_wallet wallet_0 $method
    ...
    check_balance wallet_0 2000 usdt
    # transfers
    transfer_assets wallet_0/wallet_1 2000/0     100 1900/100  1 0 usdt         # spend issuance
}

## single witness xfer, no mine
scenario_201() {
    local method="opret1st"
    # wallets
    prepare_rgb_wallet wallet_0 $method
...
## single witness xfer, no broadcast/mine
scenario_202() {
    local method="opret1st"
    # wallets
    prepare_rgb_wallet wallet_0 $method
...
## single witness aborted+retried xfer, broadcast+mine
scenario_210() {
    local method="opret1st"
    # wallets
    prepare_rgb_wallet wallet_0 $method
    ...
    check_balance wallet_0 2000 usdt
    # transfers
    transfer_create wallet_0/wallet_1 2000/0     100 1900/100  1 0 usdt         # aborted
    transfer_assets wallet_0/wallet_1 2000/0     100 1900/100  1 1 usdt         # spend issuance
}

## single witness aborted+retried xfer, no mine
scenario_211() {
    local method="opret1st"
    # wallets
    prepare_rgb_wallet wallet_0 $method
...
## single witness aborted+retried xfer, no broadcast/mine
scenario_212() {
    local method="opret1st"
    # wallets
    prepare_rgb_wallet wallet_0 $method
...
scenario_300() {
    ...
    # transfers
    SATS=99999600
    transfer_assets wallet_0/wallet_1 2000/0    2000    0/2000 1 0 usdt         # spend all issuance
    SATS=99997000
    transfer_assets wallet_1/wallet_2 2000/0    2000    0/2000 1 0 usdt         # spend all received
}
